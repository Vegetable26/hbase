...
public class TestReplicationStateHBaseImpl {
  ...
  public void setUp() {
    try {
      ...
      rp.init();
      ((TableBasedReplicationQueuesImpl) rq1).blockUntilReplicationAvailable();
    } catch (Exception e) {
  ...
  public void TestMultipleReplicationQueuesHBaseImpl () {
    try {
      rp.addPeer("Queue1", new ReplicationPeerConfig().setClusterKey("localhost:2818:/1"), null);
      rp.addPeer("Queue2", new ReplicationPeerConfig().setClusterKey("localhost:2818:/2"), null);
      rp.addPeer("Queue3", new ReplicationPeerConfig().setClusterKey("localhost:2818:/3"), null);
    } catch (ReplicationException e) {
